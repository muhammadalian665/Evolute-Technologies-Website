...
function LiveStream_Trivia_App() {
        ...
        <main className="case-study-test-page">
            ...
            <section className="case-study-test-hero">
                ...
                <div className="case-study-test-container">
                    ...
                    <h1>
                        LiveStream Trivia App
                    </h1>

                    <p>
                        This is a temporary test page for the LiveStream Trivia App case study.
...
export default LiveStream_Trivia_App;
